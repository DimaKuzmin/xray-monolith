...
extern float sil_glow_max_temp = 0.15f;					// Max possible weapon temperature
extern float sil_glow_shot_temp = 0.004f;				// Temperature added on 1 successful shot
extern float sil_glow_cool_temp_rate = 0.01f;			// Temperature removed after 1 second
...
extern float hud_fov_aim_factor = 0;
