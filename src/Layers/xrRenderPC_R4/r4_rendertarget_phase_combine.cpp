...
void CRenderTarget::CalculateBlur()
{
...
void CRenderTarget::phase_combine()
{
	...
	BOOL PP_Complex = TRUE; // Holger HUCK 
	...
	phase_combine_2(Offset, p0, p1, bDistort);
...
void CRenderTarget::phase_ssfx_combine()
{
...
void CRenderTarget::phase_combine_ssao(u32& Offset)
{
	bool _menu_pp = g_pGamePersistent ? g_pGamePersistent->OnRenderPPUI_query() : false;
...
void CRenderTarget::phase_combine_2(u32& Offset, Fvector2& p0, Fvector2& p1, bool bDistort)
{
	PIX_EVENT(combine_2);
	// 
	struct v_aa
